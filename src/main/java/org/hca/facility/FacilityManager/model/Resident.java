...
public class Resident {
    ...
    public String toString() {
        return "Resident{" +
                ...
                ", telephoneEmc1='" + telephoneEmc1 + '\'' +
                ", relationshipEmc1='" + relationshipEmc1 + '\'' +
                ", emergencyContact2='" + emergencyContact2 + '\'' +
                ", telephoneEmc2='" + telephoneEmc2 + '\'' +
                ", relationshipEmc2='" + relationshipEmc2 + '\'' +
                ", isAmbulatory='" + isAmbulatory + '\'' +
                ", isAbleToCommunicate='" + isAbleToCommunicate + '\'' +
                ", medicalInformation='" + medicalInformation + '\'' +
                ", isVaccinatedForCovid19='" + isVaccinatedForCovid19 + '\'' +
                ", lastFall=" + lastFall +
                ", lastErVisit=" + lastErVisit +
                ", dischargedFromOvernightHospitalStay='" + dischargedFromOvernightHospitalStay + '\'' +
                ", isFallRisk='" + isFallRisk + '\'' +
                ", isWanderRisk='" + isWanderRisk + '\'' +
                ", isElopementRisk='" + isElopementRisk + '\'' +
                ", physician='" + physician + '\'' +
